...
|----------------|-------|
| AC-20 (a) | - 3000045: Check whether the Financial Services Validated setting is enabled in account settings \n - 3000047: Check whether provisioned services are IAM enabled | 
{: caption="Goals for AC-20 in IBM Cloud for Financial Services v0.6.0 profile" caption-side="top"}
