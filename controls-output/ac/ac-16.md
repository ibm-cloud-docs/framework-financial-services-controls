...
- (a) Provides the means to associate _[organization-defined types of security attributes] having [organization-defined security attribute values]_ with information in storage, in process, and/or in transmission;
- (b) Ensures that the security attribute associations are made and retained with the information;
- (c) Establishes the permitted _[organization-defined security attributes] for [organization-defined information systems]_; and
...
| Requirement | Goals |
|-------------|-------|
| Part a | - 3000057: IBM Cloud provides the means to associate a customer-defined security identifier and attributes with IBM Cloud resources (for example, tags) | 
{: caption="Goals for AC-16" caption-side="top"}
