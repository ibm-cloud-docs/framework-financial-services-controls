...
AC-14 (a)
    : Identifies _[[Assignment: organization-defined user actions]_] that can be performed on the information system without identification or authentication consistent with organizational missions/business functions; and
